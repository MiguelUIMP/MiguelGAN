...
class DenseNNgenerator(torch.nn.Module):
    def __init__(self, channels, random_noise):
        ...
        self.main_module = nn.Sequential(
            ...
            nn.Linear((channels+random_noise), 400),
            nn.ReLU(True),
...
class ttbarGAN():
    ...
    def __init__(self, lat_space):
        channels = 16 # canales de salida de los datos, cuantas variables obtener
        random_noise = 160 # canales de ruido aleatorio que meter
