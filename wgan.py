            ...
            for plot_t in plot_type:
                ...
                for scale_t in scale_type:
                    ...
                    for var in samples_df:
                        ...
                        n_compare,_,_=plt.hist(compare_df[var] , bins=binSeq, density=(plot_t=="Density"), label=f'MadGraph Simulated Data; mean: {compare_mean[var]} std: {compare_std[var]}', color='green', alpha=0.5);
                        n_sample,_,_=plt.hist(samples_df[var], bins=binSeq, density=(plot_t=="Density"), label=f'CMS Real Data; mean: {samples_mean[var]} std: {samples_std[var]}', color='blue', alpha=0.5);
